...
def main():
    ...
    st.divider()
    st.markdown(f'<div class="app-footer">Finshare Pro &nbsp;•&nbsp; {datetime.now().strftime("%Y-%m-%d %H:%M")} &nbsp;•&nbsp; 📧 <a href="mailto:ravnishjangra10@gmail.com" style="color:#6b7488;">ravnishjangra10@gmail.com</a> &nbsp;•&nbsp; 🔗 <a href="https://linkedin.com/in/ravnish" target="_blank" style="color:#6b7488;">LinkedIn</a></div>', unsafe_allow_html=True)
